...
const projects = [
  { name: 'Delta', live: 'https://deltaspeed.pages.dev', repo: 'https://github.com/erfanulfarhan/delta', b: 1, desc: 'A speedtest built for Bangladesh. It measures both paths your connection has, local BDIX peering and real international bandwidth, and shows the gap between them. Pick an international server in Singapore, Mumbai or Tokyo.', tags: ['Cloudflare Workers', 'Vercel Edge', 'Web Workers', 'TypeScript'] },
  ...
  { name: 'Slate', live: 'https://store-it-c-e113.vercel.app', repo: 'https://github.com/erfanulfarhan/store-it', b: 1, desc: 'A file store with passwordless email sign-in. Drag and drop upload, browse by type, share by email. Download links are minted per request and expire, so a shared URL stops working instead of living forever.', tags: ['TypeScript', 'Next.js', 'Appwrite', 'Auth'] },
  { name: 'Exam Toolkit', live: 'https://edexcel-grade-calc.vercel.app', repo: 'https://github.com/erfanulfarhan/exam-toolkit', b: 1, desc: 'Free revision tools for Edexcel International A Level and IGCSE: a UMS grade calculator built from every published boundary, past papers beside mark schemes, a mock timer and a study planner.', tags: ['TypeScript', 'React', 'Grade Data'] },
  { name: 'JARVIS', repo: 'https://github.com/erfanulfarhan/Jarvis-by-Erfanul-Farhan', desc: 'An offline-first macOS voice assistant. Speech in, speech out, running locally so it keeps working without a connection.', tags: ['macOS', 'Voice', 'Offline'] },
  { name: 'GazeKit', repo: 'https://github.com/erfanulfarhan/gazekit', desc: 'Calibrates and verifies gaze correction on macOS, measuring whether it actually works rather than taking the vendor\u2019s word for it.', tags: ['Swift', 'macOS', 'Measurement'] },
  ...
  { name: 'Cineplex Automation', repo: 'https://github.com/erfanulfarhan/cineplex-bot', desc: 'A Telegram bot + web app tracking cinema seats in real time, rendering seat maps, and auto-booking tickets on sale.', tags: ['Python', 'Playwright', 'aiohttp', 'Telegram'] },
