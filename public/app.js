...
const projects = [
  { name: 'Aria', live: 'https://aria-voice-erfanul.vercel.app', repo: 'https://github.com/erfanulfarhan/aria-voice', b: 1, desc: 'A voice-first AI assistant — talk to it and it talks back. Audio-reactive orb, real-time speech recognition and synthesis, powered by Llama 3.3 70B.', tags: ['React', 'Web Speech API', 'Motion', 'Groq'] },
