...
const projects = [
  ...
  { name: 'NSU Result Checker', repo: 'https://github.com/erfanulfarhan/nsu-result-checker', desc: 'Looks up an NSU undergraduate admission result from a test pass number, so applicants do not have to sit refreshing a portal.', tags: ['Python', 'Automation'] },
